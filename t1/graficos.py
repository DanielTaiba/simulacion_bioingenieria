...
if __name__=='__main__':
  ...
  r = 2
  title='Estado inicial (sin iteracion)'
  plot(df[df['iteracion']==0],df.columns[2:],incluir_vecindad,title,r)

  jump_plots = 5 #cada cuantas iteraciones se muestra un grafico
